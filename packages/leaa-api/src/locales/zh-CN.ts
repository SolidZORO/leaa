export default {
  _error: {
    ...
    tokenError: 'Token 错误',
    tokenNotBefore: '未找到 Token Before',
    tokenExpired: 'Token 已过期',
    tokenVerifyFaild: 'Token 验证失败',
    tokenNotPrefix: '未找到 Token 前缀',
    //
    //
    notAuth: '没有授权',
    notFound: '未找到',
    ...
    updateItemFailed: '更新条目失败',
    readItemFailed: '读取条目失败',
    deleteItemFailed: '删除条目失败',
    //
    illegalUser: '非法用户',
    invalidUser: '无效用户',
    invalidId: '无效 ID',
  ...
  _module: {
    coupon: {
      couponUnavailable: '优惠券不可用',
      couponIrredeemable: '优惠券无法兑换',
      couponAlreadyRedeemed: '优惠券已兑换',
    },
    promo: {
      unavailable: '促销码不可用',
    },
