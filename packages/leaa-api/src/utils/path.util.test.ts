...
describe('pathUtil', () => {
  describe('getAt2xPath', () => {
    it('should get at 2x path', async () => {
      ...
      expect(pathUtil.getAt2xPath(at1xPath)).toBe(at2xPath);
    });

    it('should get at 2x path (long)', async () => {
    ...
    it('should get null', async () => {
      ...
      expect(pathUtil.getAt2xPath(at1xPath)).toBe(null);
    });
  });
});
