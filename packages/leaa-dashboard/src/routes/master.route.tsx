  ...
  //
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/products/:id([\\w]{8}-[\\w]{4}-[\\w]{4}-[\\w]{4}-[\\w]{12})',
        icon: 'ri-shirt-line',
        LazyComponent: React.lazy(() =>
  ...
  //
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/coupons/:id([\\w]{8}-[\\w]{4}-[\\w]{4}-[\\w]{4}-[\\w]{12})',
        icon: 'ri-coupon-line',
        LazyComponent: React.lazy(() =>
      ...
      },
      {
        ...
        path: '/promos/:id([\\w]{8}-[\\w]{4}-[\\w]{4}-[\\w]{4}-[\\w]{12})',
        icon: 'ri-coupon-3-line',
        LazyComponent: React.lazy(() =>
      ...
      {
        name: 'Create Zan',
        namei18n: '_route:createZan',
        permission: 'zan.item-create',
        path: '/zans/create',
        icon: 'ri-thumb-up-line',
        LazyComponent: React.lazy(() => import(/* webpackChunkName: 'CreateZan' */ '../pages/Zan/CreateZan/CreateZan')),
        exact: true,
        isCreate: true,
      },
      {
        ...
        path: '/zans/:id([\\w]{8}-[\\w]{4}-[\\w]{4}-[\\w]{4}-[\\w]{12})',
        icon: 'ri-thumb-up-line',
      ...
      },
      {
        name: 'Zan',
        namei18n: '_route:zan',
        permission: 'zan.list-read',
        path: '/zans',
        icon: 'ri-thumb-up-line',
        LazyComponent: React.lazy(() => import(/* webpackChunkName: 'ZanList' */ '../pages/Zan/ZanList/ZanList')),
        canCreate: true,
        exact: true,
      },
    ],
  ...
  //
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/addresses/:id([\\w]{8}-[\\w]{4}-[\\w]{4}-[\\w]{4}-[\\w]{12})',
        icon: 'ri-map-pin-user-line',
        LazyComponent: React.lazy(() =>
      ...
      },
      {
        ...
        permission: 'address.item-read',
        path: '/divisions/:id([\\w]{8}-[\\w]{4}-[\\w]{4}-[\\w]{4}-[\\w]{12})',
        icon: 'ri-map-2-line',
        LazyComponent: React.lazy(() =>
