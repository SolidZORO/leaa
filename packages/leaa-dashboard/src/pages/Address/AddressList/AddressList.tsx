...
export default (props: IPage) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'address',
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'address'),
    ...
    },
    {
      ...
      dataIndex: 'consignee',
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'consignee'),
    ...
    },
    {
      ...
      dataIndex: 'phone',
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'phone'),
    ...
    },
    {
      ...
      render: (text: string, record: Address) => (
        <TableColumnDeleteButton
          ...
          onClick={async () => deleteAddressMutate({ variables: { id: record.id } })}
        />
      ),
    },
  ];
