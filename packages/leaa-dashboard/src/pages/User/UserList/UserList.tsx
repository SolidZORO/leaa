...
export default (props: IPage) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'is_admin',
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'is_admin'),
    ...
    },
    {
      ...
      dataIndex: 'email',
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'email'),
    ...
    },
    {
      ...
      render: (text: string, record: User) => (
        <TableColumnDeleteButton
          ...
          onClick={async () => deleteUserMutate({ variables: { id: record.id } })}
        />
      ),
    },
  ];
