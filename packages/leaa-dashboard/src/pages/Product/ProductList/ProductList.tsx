...
import { GET_PRODUCTS, DELETE_PRODUCT, UPDATE_PRODUCT } from '@leaa/dashboard/src/graphqls';
...
export default (props: IPage) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 100,
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'stock'),
    ...
    },
    {
      ...
      dataIndex: 'price',
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'price'),
    ...
    },
    {
      ...
      sorter: true,
      sortOrder: calcTableDefaultSortOrder(tablePagination.orderSort, tablePagination.orderBy, 'status'),
      render: (text: string, record: Product) => (
        <TableColumnStatusSwitch
          id={record.id}
    ...
    <PageCard
      ...
      extra={
        <div className="g-page-card-extra-filter-bar-wrapper">
          <FilterIcon showClose={urlParams} onClose={() => props.history.push('/products')} />
