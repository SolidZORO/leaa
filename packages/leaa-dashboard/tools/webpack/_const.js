...
WPCONST.CHUNK_HASH = WPCONST.__DEV__ ? '_devvvvvvvvvvvv' : '_[chunkhash:8]';
WPCONST.STYLE_CHUNK_HASH = WPCONST.__DEV__ ? '_devvvvvvvvvvvv' : '_[contenthash:8]';
...
WPCONST.OUTPUT_SCRIPT_CHUNK_FILENAME = `${WPCONST.DEV_PREFIX}scripts/chunks/[name]${WPCONST.CHUNK_HASH}.js`;

WPCONST.OUTPUT_STYLE_FILENAME = `${WPCONST.DEV_PREFIX}styles/[name]${WPCONST.STYLE_CHUNK_HASH}.css`;
WPCONST.OUTPUT_STYLE_CHUNK_FILENAME = `${WPCONST.DEV_PREFIX}styles/chunks/[name]${WPCONST.STYLE_CHUNK_HASH}.css`;
