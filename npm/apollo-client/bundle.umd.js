(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(exports, require("../tslib/tslib.js"), require("../apollo-utilities/lib/bundle.cjs.js"), require("../apollo-link/lib/index.js"), require("../symbol-observable/lib/index.js"), require("../ts-invariant/lib/invariant.js"), require("../graphql/language/visitor.js"));
  } else {
    var mod = {
      exports: {}
    };
  ...
  _exports.ObservableQuery = _exports.NetworkStatus = _exports.FetchType = _exports.ApolloError = _exports.ApolloClient = _exports.default = undefined;
  ...
  var ObservableQuery = function (_super) {
    ...
    function ObservableQuery(_a) {
      var queryManager = _a.queryManager,
          ...
          shouldSubscribe = _b === undefined ? true : _b;
    ...
    ObservableQuery.prototype.getCurrentResult = function () {
      if (this.isTornDown) {
        ...
        return {
          data: !this.lastError && lastResult && lastResult.data || undefined,
    ...
    ObservableQuery.prototype.refetch = function (variables) {
      ...
      if (fetchPolicy === 'cache-only') {
        return Promise.reject(new _tsInvariant.InvariantError('cache-only fetchPolicy option should not be used together with query refetch.'));
      }
    ...
    ObservableQuery.prototype.fetchMore = function (fetchMoreOptions) {
      ...
      (0, _tsInvariant.invariant)(fetchMoreOptions.updateQuery, 'updateQuery option is required. This function defines how to update the query data with the new results.');
    ...
    ObservableQuery.prototype.subscribeToMore = function (options) {
      ...
      var subscription = this.queryManager.startGraphQLSubscription({
        ...
        error: function (err) {
          ...
          false || _tsInvariant.invariant.error('Unhandled GraphQL subscription error', err);
        }
      });
  ...
  function defaultSubscriptionObserverErrorCallback(error) {
    false || _tsInvariant.invariant.error('Unhandled error', error.message, error.stack);
  }
  ...
  function assertNotCacheFirstOrOnly(obsQuery) {
    ...
    (0, _tsInvariant.invariant)(fetchPolicy !== 'cache-first' && fetchPolicy !== 'cache-only', 'Queries that specify the cache-first and cache-only fetchPolicies cannot also be polling queries.');
  }
  ...
  var QueryStore = function () {
    ...
    QueryStore.prototype.initQuery = function (query) {
      ...
      (0, _tsInvariant.invariant)(!previousQuery || previousQuery.document === query.document || (0, _apolloUtilities.isEqual)(previousQuery.document, query.document), 'Internal Error: may not update existing query string in store');
  ...
  var LocalState = function () {
    ...
    LocalState.prototype.runResolvers = function (_a) {
      var document = _a.document,
          ...
          onlyRunForcedResolvers = _b === undefined ? false : _b;
      return (0, _tslib.__awaiter)(this, undefined, undefined, function () {
    ...
    LocalState.prototype.clientQuery = function (document) {
      if ((0, _apolloUtilities.hasDirectives)(['client'], document)) {
        ...
        false || _tsInvariant.invariant.warn("Found @client directives in a query but no ApolloClient resolvers were specified. This means ApolloClient local resolver handling has been disabled, and @client directives will be passed through to your link chain.");
      }
      ...
      var newContext = (0, _tslib.__assign)({}, context, {
        ...
        getCacheKey: function (obj) {
          if (cache.config) {
            ...
            (0, _tsInvariant.invariant)(false, "To use context.getCacheKey, you need to use a cache that has a configurable dataIdFromObject, like apollo-cache-inmemory.");
          }
        }
      });
      return newContext;
    ...
    LocalState.prototype.resolveDocument = function (document, rootValue, context, variables, fragmentMatcher, onlyRunForcedResolvers) {
      ...
      if (onlyRunForcedResolvers === undefined) {
      ...
      return (0, _tslib.__awaiter)(this, undefined, undefined, function () {
        ...
        return (0, _tslib.__generator)(this, function (_a) {
          ...
          execute = function (selection) {
            return (0, _tslib.__awaiter)(_this, undefined, undefined, function () {
              ...
              return (0, _tslib.__generator)(this, function (_a) {
                ...
                if ((0, _apolloUtilities.isInlineFragment)(selection)) {
                  ...
                  (0, _tsInvariant.invariant)(fragment, "No fragment named " + selection.name.value);
                }
  ...
  var QueryManager = function () {
    function QueryManager(_a) {
      var link = _a.link,
          ...
          queryDeduplication = _b === undefined ? false : _b,
          store = _a.store,
          _c = _a.onBroadcast,
          onBroadcast = _c === undefined ? function () {
        return undefined;
      } : _c,
          _d = _a.ssrMode,
          ssrMode = _d === undefined ? false : _d,
          _e = _a.clientAwareness,
          clientAwareness = _e === undefined ? {} : _e,
    ...
    QueryManager.prototype.mutate = function (_a) {
      var mutation = _a.mutation,
          ...
          refetchQueries = _b === undefined ? [] : _b,
          _c = _a.awaitRefetchQueries,
          awaitRefetchQueries = _c === undefined ? false : _c,
          updateWithProxyFn = _a.update,
          _d = _a.errorPolicy,
          errorPolicy = _d === undefined ? 'none' : _d,
          fetchPolicy = _a.fetchPolicy,
          _e = _a.context,
          context = _e === undefined ? {} : _e;
      return (0, _tslib.__awaiter)(this, undefined, undefined, function () {
        ...
        return (0, _tslib.__generator)(this, function (_f) {
          switch (_f.label) {
            case 0:
              (0, _tsInvariant.invariant)(mutation, 'mutation option is required. You must specify your GraphQL document in the mutation option.');
              (0, _tsInvariant.invariant)(!fetchPolicy || fetchPolicy === 'no-cache', "fetchPolicy for mutations currently only supports the 'no-cache' policy");
    ...
    QueryManager.prototype.fetchQuery = function (queryId, options, fetchType, fetchMoreForQueryId) {
      return (0, _tslib.__awaiter)(this, undefined, undefined, function () {
        ...
        return (0, _tslib.__generator)(this, function (_e) {
          switch (_e.label) {
            case 0:
              _a = options.metadata, metadata = _a === undefined ? null : _a, _b = options.fetchPolicy, fetchPolicy = _b === undefined ? 'cache-first' : _b, _c = options.context, context = _c === undefined ? {} : _c;
      ...
      function invoke(method, argument) {
        if (observer[method]) {
          try {
            ...
            false || _tsInvariant.invariant.error(e);
          }
        } else if (method === 'error') {
          false || _tsInvariant.invariant.error(argument);
        }
      }
    ...
    QueryManager.prototype.watchQuery = function (options, shouldSubscribe) {
      ...
      (0, _tsInvariant.invariant)(options.fetchPolicy !== 'standby', 'client.watchQuery cannot be called with fetchPolicy set to "standby"');
    ...
    QueryManager.prototype.query = function (options) {
      ...
      (0, _tsInvariant.invariant)(options.query, "query option is required. You must specify your GraphQL document in the query option.");
      (0, _tsInvariant.invariant)(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
      (0, _tsInvariant.invariant)(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
      (0, _tsInvariant.invariant)(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
      return new Promise(function (resolve, reject) {
    ...
    QueryManager.prototype.startQuery = function (queryId, options, listener) {
      false || _tsInvariant.invariant.warn("The QueryManager.startQuery method has been deprecated");
    ...
    QueryManager.prototype.getCurrentQueryResult = function (observableQuery, optimistic) {
      ...
      return {
        data: complete || returnPartialData ? result : undefined,
        partial: !complete
      };
    };
    ...
    QueryManager.prototype.getQueryWithPreviousResult = function (queryIdOrObservable) {
      ...
      if (typeof queryIdOrObservable === 'string') {
        ...
        (0, _tsInvariant.invariant)(foundObserveableQuery, "ObservableQuery with this id doesn't exist: " + queryIdOrObservable);
    ...
    QueryManager.prototype.getObservableFromLink = function (query, context, variables, deduplication) {
      ...
      if (serverQuery) {
        ...
        var operation = {
          query: serverQuery,
          variables: variables,
          operationName: (0, _apolloUtilities.getOperationName)(serverQuery) || undefined,
    ...
    QueryManager.prototype.fetchRequest = function (_a) {
      ...
      var variables = options.variables,
          ...
          errorPolicy = _b === undefined ? 'none' : _b,
    ...
    QueryManager.prototype.startPollingQuery = function (options, queryId, listener) {
      ...
      (0, _tsInvariant.invariant)(pollInterval, 'Attempted to start a polling query without a polling interval.');
  ...
  var ApolloClient = function () {
    function ApolloClient(options) {
      ...
      var cache = options.cache,
          _a = options.ssrMode,
          ssrMode = _a === undefined ? false : _a,
          _b = options.ssrForceFetchDelay,
          ssrForceFetchDelay = _b === undefined ? 0 : _b,
          connectToDevTools = options.connectToDevTools,
          _c = options.queryDeduplication,
          queryDeduplication = _c === undefined ? true : _c,
          defaultOptions = options.defaultOptions,
          _d = options.assumeImmutableResults,
          assumeImmutableResults = _d === undefined ? false : _d,
      ...
      if (!link || !cache) {
        throw new _tsInvariant.InvariantError("In order to initialize Apollo Client, you must specify 'link' and 'cache' properties in the options object.\nThese options are part of the upgrade requirements when migrating from Apollo Client 1.x to Apollo Client 2.x.\nFor more information, please visit: https://www.apollographql.com/docs/tutorial/client.html#apollo-client-setup");
      }
    ...
    ApolloClient.prototype.query = function (options) {
      ...
      (0, _tsInvariant.invariant)(options.fetchPolicy !== 'cache-and-network', "The cache-and-network fetchPolicy does not work with client.query, because client.query can only return a single result. Please use client.watchQuery to receive multiple results from the cache and the network, or consider using a different fetchPolicy, such as cache-first or network-only.");
    ...
    ApolloClient.prototype.initQueryManager = function () {
      false || _tsInvariant.invariant.warn("Calling the initQueryManager method is no longer necessary, and it will be removed from ApolloClient in version 3.0.");
